...
- "validation_report": Validation report with is_valid, errors, missing_fields, warnings, gaps
- "evidence_store": Evidence store with items (organized by section), by_section, by_source, hash_index, gaps
- "research_plan": Research plan with disease, sections, key_questions, scope
...
Ensure the output is complete, accurate, and follows the DeepResearchOutput schema. Address any validation errors, warnings, or gaps from the validation_report. Use the research plan's sections to guide the narrative structure.
